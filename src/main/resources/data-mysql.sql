...
-- rm -rf 게시글 신고들 (어제 집중)
(1, 1, 'DANGER', 5, 'sudo 권한 획득 시도 증거', NOW() - INTERVAL 1 DAY - INTERVAL 3 HOUR),
(2, 1, 'DANGER', 4, '시스템 파일 삭제 시도', NOW() - INTERVAL 1 DAY - INTERVAL 1 HOUR),
(3, 1, 'ABUSE', 3, '위험한 명령어 공유', NOW() - INTERVAL 1 DAY),
(28, 1, 'DANGER', 5, '시스템 파괴 코드 공유', NOW() - INTERVAL 1 DAY + INTERVAL 2 HOUR),
(29, 1, 'SECURITY', 5, '치명적 시스템 손상 가능성', NOW() - INTERVAL 1 DAY + INTERVAL 4 HOUR),
-- eval() 게시글 신고들 (어제)
(4, 2, 'HACK', 5, 'XSS 공격 코드 포함', NOW() - INTERVAL 1 DAY - INTERVAL 2 HOUR),
(5, 2, 'DANGER', 4, '악성 스크립트 실행 시도', NOW() - INTERVAL 1 DAY + INTERVAL 1 HOUR),
-- 와일드카드 게시글 신고들 (어제)
(6, 3, 'DANGER', 3, '파일 시스템 손상 위험', NOW() - INTERVAL 1 DAY + INTERVAL 3 HOUR),
-- chmod 777 게시글 신고들 (어제)
(7, 4, 'SECURITY', 5, '보안 취약점 유발', NOW() - INTERVAL 1 DAY - INTERVAL 4 HOUR),
(8, 4, 'DANGER', 4, '권한 설정 오용', NOW() - INTERVAL 1 DAY),
(9, 4, 'ABUSE', 3, '잘못된 관리 방법 조장', NOW() - INTERVAL 1 DAY + INTERVAL 5 HOUR),
-- SQL Injection 게시글 신고들 (어제 집중)
(10, 5, 'HACK', 5, 'DB 공격 코드 포함', NOW() - INTERVAL 1 DAY - INTERVAL 5 HOUR),
(11, 5, 'DANGER', 5, '보안 취약점 악용', NOW() - INTERVAL 1 DAY - INTERVAL 1 HOUR),
(12, 5, 'SECURITY', 4, 'DB 보안 위협', NOW() - INTERVAL 1 DAY + INTERVAL 2 HOUR),
(25, 5, 'HACK', 5, 'DB 삭제 시도 증거', NOW() - INTERVAL 1 DAY + INTERVAL 3 HOUR),
(26, 5, 'DANGER', 5, 'DB 계정 탈취 시도', NOW() - INTERVAL 1 DAY + INTERVAL 6 HOUR),
(27, 5, 'SECURITY', 5, '고객정보 유출 위험', NOW() - INTERVAL 1 DAY + INTERVAL 7 HOUR),
-- fork 폭탄 게시글 신고들 (어제 집중)
(13, 6, 'DANGER', 5, '시스템 자원 고갈 유도', NOW() - INTERVAL 1 DAY - INTERVAL 2 HOUR),
(14, 6, 'ABUSE', 4, 'DoS 공격 방법 공유', NOW() - INTERVAL 1 DAY + INTERVAL 1 HOUR),
(30, 6, 'DANGER', 5, 'DoS 공격 코드 포함', NOW() - INTERVAL 1 DAY + INTERVAL 4 HOUR),
(31, 6, 'SECURITY', 5, '서버 자원 고갈 위험', NOW() - INTERVAL 1 DAY + INTERVAL 8 HOUR),
(32, 6, 'ABUSE', 5, '시스템 크래시 유발', NOW() - INTERVAL 1 DAY + INTERVAL 9 HOUR),
-- kill -9 게시글 신고들 (어제)
(15, 7, 'ABUSE', 3, '과격한 시스템 운영 조장', NOW() - INTERVAL 1 DAY + INTERVAL 5 HOUR),
-- 재귀 호출 게시글 신고들 (어제)
(16, 8, 'DANGER', 4, '시스템 크래시 유발', NOW() - INTERVAL 1 DAY - INTERVAL 1 HOUR),
(17, 8, 'ABUSE', 3, '잘못된 프로그래밍 조장', NOW() - INTERVAL 1 DAY + INTERVAL 6 HOUR),
-- dd 명령어 게시글 신고들 (이틀 전 - 배치 대상 외)
(18, 9, 'DANGER', 5, '디스크 손상 위험', NOW() - INTERVAL 2 DAY),
(19, 9, 'SECURITY', 4, '시스템 안정성 위협', NOW() - INTERVAL 2 DAY + INTERVAL 2 HOUR),
-- 커널 패닉 게시글 신고들 (오늘 - 배치 대상 외)
(20, 10, 'DANGER', 5, '시스템 안정성 위협', NOW() - INTERVAL 2 HOUR),
(21, 10, 'SECURITY', 5, '커널 충돌 유발', NOW() - INTERVAL 1 HOUR),
(33, 10, 'DANGER', 5, '커널 공격 코드 포함', NOW() - INTERVAL 30 MINUTE),
(34, 10, 'SECURITY', 5, '시스템 불능 유발', NOW() - INTERVAL 10 MINUTE),
-- 버퍼 오버플로우 게시글 신고 (어제)
(22, 11, 'SECURITY', 4, '메모리 침범 위험', NOW() - INTERVAL 1 DAY + INTERVAL 10 HOUR),
